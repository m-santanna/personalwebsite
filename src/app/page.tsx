...
function Socials() {
  return (
    <div className="mt-2 flex items-center gap-4 font-medium text-sm sm:text-md">
  ...
  return (
    <div className="mx-8 sm:mx-30 space-y-10 mb-6">
      ...
      <div className="mt-10 flex flex-col gap-6">
        <div className="text-primary font-bold text-3xl flex flex-col sm:flex-row items-center gap-1 sm:gap-4">
          <h1>
            Hello World!
          </h1>
          <h1>
        ...
        <p className="max-w-2xl text-md sm:text-lg">
          I also built <Link target="_blank" href={JPRAC_URL}><StyledSpan textOnHover="jprac" text="jprac" /></Link>, which is my favorite project from the bunch. In short, it allows friends to compete in real-time, and see who knows the japanese alphabet the best!
        </p>
        <Socials />
      </div>
