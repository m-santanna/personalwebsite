          ...
          <div className="flex ml-2">
            ...
            <div>
              <div className="relative pl-6 pb-8">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-primary leading-tight mt-1">FCT — Universidade NOVA de Lisboa</h3>
              ...
              <div className="relative pl-6 pb-8">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-primary leading-tight mt-1">IST — Universidade de Lisboa</h3>
                <p className="text-sm text-primary/70 mt-1 flex items-center gap-2">
                  B.Sc. in Biomedical Engineering
                  <Tooltip direction="bottom" padding="px-4 py-1.5" size="w-54" icon={<Info className="size-4 hidden sm:block" />} text="I dropped out though." />
                </p>
              </div>
              ...
              <div className="relative pl-6">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-primary leading-tight mt-1">Colégio Farroupilha</h3>
          ...
          <div className="flex ml-2">
            ...
            <div className="relative pl-6">
              ...
              <div className="mt-4 space-y-4 max-w-2xl text-primary/80 text-sm sm:text-base leading-relaxed">
                <p>
                  <span className="text-primary font-semibold">TL;DR:</span> Architected and built a full-stack AI platform from scratch for the team, using Next.js and LLMs to automate HR workflows and reduce manual drafting time by ~50%.
                </p>
                {showMore && (
                  <>
                    <p>
